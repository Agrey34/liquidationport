...
export default function LoginPage() {
  ...
  // NOTE: Redirect target is always /admin — the server action enforces
  // that the redirectTo path starts with /admin and is not a login/signup page.
  // We do NOT read from localStorage to determine redirect paths (security).
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // redirectTo defaults to /admin; the server action validates this
    ...
    // On success, redirect is handled by the server action
  };
      ...
      >
        <div className="bg-white p-8 w-full rounded-[20px] shadow-sm flex flex-col gap-2.5">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            {/* The server action validates that redirectTo is a safe /admin path */}
