      ...
      >
        <div className="bg-white p-8 w-full rounded-[20px] shadow-sm flex flex-col gap-2.5">
          <div className="mb-4 text-center">
            <h1 className="text-2xl font-bold text-[#151717]">Create Account</h1>
            <p className="text-neutral-500 text-sm mt-1">Join the liquidation platform</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
                ...
                <div className="border-[1.5px] border-[#ecedec] rounded-[10px] h-12.5 flex items-center px-3 transition-colors duration-200 focus-within:border-[#2d79f3]">
                  <input
                    name="firstName"
                    required
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="border-[1.5px] border-[#ecedec] rounded-[10px] h-12.5 flex items-center pl-3 transition-colors duration-200 focus-within:border-[#2d79f3]">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-[#151717] font-semibold text-sm">Confirm Password</label>
              <div className="border-[1.5px] border-[#ecedec] rounded-[10px] h-12.5 flex items-center pl-3 transition-colors duration-200 focus-within:border-[#2d79f3]">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="-64 0 512 512" height="20" fill="#a0a0a0"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path></svg>        
                <input
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center justify-between">
                <label className="text-[#151717] font-semibold text-sm flex items-center gap-1.5">
                  <ShieldCheck className="w-4 h-4 text-[#2d79f3]" />
                  Admin Passcode
                </label>
              ...
              <div className="border-[1.5px] border-[#ecedec] rounded-[10px] h-12.5 flex items-center pl-3 transition-colors duration-200 focus-within:border-[#2d79f3]">
                <KeyRound className="w-5 h-5 text-neutral-400 shrink-0" />
                <input
                  name="passcode"
                  required
              ...
              <p className="text-[11px] text-neutral-500 mt-0.5">
                Structural protection: Authorization key required to provision administrative privileges.
              </p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-6 mb-2 bg-[#151717] border-none text-white text-[15px] font-medium rounded-[10px] h-12.5 w-full cursor-pointer transition-colors hover:bg-black disabled:opacity-70 flex justify-center items-center"
            >
              {loading ? (
          ...
          <p className="text-center text-black text-sm my-1.5">
            ...
            <Link href="/admin-login" className="text-[#2d79f3] font-medium cursor-pointer hover:underline ml-1">
              Sign In
            </Link>
          </p>
          ...
          <div className="flex flex-row items-center gap-2.5 justify-between">
            <button className="mt-1 w-full h-12.5 rounded-[10px] flex justify-center items-center font-medium gap-2.5 border border-[#ededef] bg-white cursor-pointer transition-colors hover:border-[#2d79f3] text-[#151717] text-sm">
